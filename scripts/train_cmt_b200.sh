...
# Paired one-step diagnostic on one immutable Competition-MATH test subset.
...
export ONE_STEP_KL_PROBE_MAX_NEW_TOKENS="${ONE_STEP_KL_PROBE_MAX_NEW_TOKENS:-512}"
export ONE_STEP_KL_PROBE_TEMPERATURE="${ONE_STEP_KL_PROBE_TEMPERATURE:-1.0}"
export ONE_STEP_KL_PROBE_TOP_P="${ONE_STEP_KL_PROBE_TOP_P:-1.0}"
...
echo "One-step KL probe: enabled=${ONE_STEP_KL_PROBE_ENABLED}, heldout=${ONE_STEP_KL_PROBE_SUBSET_SIZE}, interval=${ONE_STEP_KL_PROBE_INTERVAL}"
