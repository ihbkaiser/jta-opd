...
# Paired on-policy trajectory diagnostic from fixed Competition-MATH test roots.
export ONE_STEP_KL_PROBE_ENABLED="${ONE_STEP_KL_PROBE_ENABLED:-true}"
export ONE_STEP_KL_PROBE_BENCHMARK="${ONE_STEP_KL_PROBE_BENCHMARK:-Competition-MATH}"
export ONE_STEP_KL_PROBE_SUBSET_SIZE="${ONE_STEP_KL_PROBE_SUBSET_SIZE:-64}"
export ONE_STEP_KL_PROBE_NUM_ROLLOUTS_PER_PROBLEM="${ONE_STEP_KL_PROBE_NUM_ROLLOUTS_PER_PROBLEM:-2}"
export ONE_STEP_KL_PROBE_HORIZON="${ONE_STEP_KL_PROBE_HORIZON:-64}"
export ONE_STEP_KL_PROBE_SEED="${ONE_STEP_KL_PROBE_SEED:-20260923}"
export ONE_STEP_KL_PROBE_INTERVAL="${ONE_STEP_KL_PROBE_INTERVAL:-50}"
export ONE_STEP_KL_PROBE_SAMPLING_TEMPERATURE="${ONE_STEP_KL_PROBE_SAMPLING_TEMPERATURE:-1.0}"
export ONE_STEP_KL_PROBE_SAMPLING_TOP_P="${ONE_STEP_KL_PROBE_SAMPLING_TOP_P:-1.0}"
export ONE_STEP_KL_PROBE_GENERATION_BATCH_SIZE="${ONE_STEP_KL_PROBE_GENERATION_BATCH_SIZE:-8}"
...
echo "Trajectory KL probe: enabled=${ONE_STEP_KL_PROBE_ENABLED}, roots=${ONE_STEP_KL_PROBE_SUBSET_SIZE}, rollouts/root=${ONE_STEP_KL_PROBE_NUM_ROLLOUTS_PER_PROBLEM}, horizon=${ONE_STEP_KL_PROBE_HORIZON}, interval=${ONE_STEP_KL_PROBE_INTERVAL}"
