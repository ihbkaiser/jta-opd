...
build_training_args() {
  ...
  COMMON_TRAIN_ARGS=(
    ...
    --set "one_step_kl_probe.seed=${ONE_STEP_KL_PROBE_SEED:-20260922}"
    --set "one_step_kl_probe.interval_steps=${ONE_STEP_KL_PROBE_INTERVAL:-1}"
    --set "one_step_kl_probe.max_new_tokens=${ONE_STEP_KL_PROBE_MAX_NEW_TOKENS:-512}"
    --set "one_step_kl_probe.temperature=${ONE_STEP_KL_PROBE_TEMPERATURE:-1.0}"
    --set "one_step_kl_probe.top_p=${ONE_STEP_KL_PROBE_TOP_P:-1.0}"
