...
def _record(step: int = 7, *, kl_after_cmt: float = 0.8) -> dict:
    ...
    return {
        ...
        "sampling_seed": 123,
        "successor_state_hash": "successors-sha256",
        "valid_successor_state_count": 256,
        "top_k": 16,
        ...
        "delta_uniform_standard_error": 0.01,
        "delta_cmt": delta_cmt,
        "delta_cmt_standard_error": 0.02,
        "paired_gap": delta_cmt - delta_uniform,
        "paired_gap_standard_error": 0.03,
