...
def validate_append_history(
    ...
    try:
        for filename, kind, step_field in (
            ...
            (
                "one_step_trajectory_kl_probe/trajectory_kl_probe.jsonl",
                "jsonl",
                "optimizer_step",
            ),
            (
                "one_step_trajectory_kl_probe/trajectory_kl_probe.csv",
                "csv",
                "optimizer_step",
            ),
            (
                "one_step_trajectory_kl_probe/trajectory_kl_per_problem.jsonl",
                "jsonl",
                "optimizer_step",
            ),
            (
                "one_step_trajectory_kl_probe/trajectory_kl_per_problem.csv",
                "csv",
                "optimizer_step",
            ),
        ):
...
_RESUME_COMPATIBILITY_DEFAULTS = {
    ...
    "one_step_kl_probe.enabled": False,
    "one_step_kl_probe.state_source": "on_policy_heldout_roots",
    "one_step_kl_probe.benchmark": "Competition-MATH",
    "one_step_kl_probe.subset_size": 64,
    "one_step_kl_probe.num_rollouts_per_problem": 2,
    "one_step_kl_probe.horizon": 64,
    "one_step_kl_probe.seed": 20260923,
    "one_step_kl_probe.interval_steps": 50,
    "one_step_kl_probe.metric": "full_vocab_reverse_kl",
    "one_step_kl_probe.failure_policy": "error",
    "one_step_kl_probe.sampling_temperature": 1.0,
    "one_step_kl_probe.sampling_top_p": 1.0,
    "one_step_kl_probe.generation_batch_size": 8,
    "one_step_kl_probe.score_micro_batch_size": 1,
}
...
def validate_resume_config(
    ...
    *,
    ...
    keys = (
        ...
        "one_step_kl_probe.enabled",
        "one_step_kl_probe.state_source",
        "one_step_kl_probe.benchmark",
        "one_step_kl_probe.subset_size",
        "one_step_kl_probe.num_rollouts_per_problem",
        "one_step_kl_probe.horizon",
        "one_step_kl_probe.seed",
        "one_step_kl_probe.interval_steps",
        "one_step_kl_probe.metric",
        "one_step_kl_probe.failure_policy",
        "one_step_kl_probe.sampling_temperature",
        "one_step_kl_probe.sampling_top_p",
        "one_step_kl_probe.generation_batch_size",
        "one_step_kl_probe.score_micro_batch_size",
        "token_budget.rho",
