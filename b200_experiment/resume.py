...
_RESUME_COMPATIBILITY_DEFAULTS = {
    ...
    "one_step_kl_probe.state_source": "training_rollout_successors",
    "one_step_kl_probe.parent_state_count": 64,
    "one_step_kl_probe.successors_per_parent": 4,
...
def validate_resume_config(
    ...
    *,
    ...
    keys = (
        ...
        "one_step_kl_probe.parent_state_count",
        "one_step_kl_probe.successors_per_parent",
