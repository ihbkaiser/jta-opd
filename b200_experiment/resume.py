...
_RESUME_COMPATIBILITY_DEFAULTS = {
    ...
    "one_step_kl_probe.seed": 20260922,
    "one_step_kl_probe.interval_steps": 1,
    "one_step_kl_probe.top_k": 16,
    "one_step_kl_probe.metric": "conditional_reverse_kl",
    "one_step_kl_probe.failure_policy": "error",
    "one_step_kl_probe.max_new_tokens": 512,
    "one_step_kl_probe.temperature": 1.0,
    "one_step_kl_probe.top_p": 1.0,
...
def validate_resume_config(
    ...
    *,
    ...
    keys = (
        ...
        "one_step_kl_probe.top_k",
        "one_step_kl_probe.metric",
        "one_step_kl_probe.failure_policy",
        "one_step_kl_probe.max_new_tokens",
        "one_step_kl_probe.temperature",
        "one_step_kl_probe.top_p",
